...
const api = {
    key: "7059cb3095d61e6b1fcfb01d0fdf3946",
...
const temp_number = document.querySelector('.container-temp Text:first-child');
const temp_unit = document.querySelector('.container-temp Text:last-child');
